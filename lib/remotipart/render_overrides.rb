  ...
  module RenderOverrides
    ...
    def self.included(base)
      base.class_eval do
        ...
        alias head_without_remotipart head
        alias head head_with_remotipart
      end
    end

    def head_with_remotipart(*args, &block)
      head_without_remotipart(*args, &block).tap do
        patch_remotipart!
      end
    end

    def render_with_remotipart(*args, &block)
      render_without_remotipart(*args, &block).tap do
        patch_remotipart!
      end
    end
    ...
    def patch_remotipart!
      return unless remotipart_submitted?
